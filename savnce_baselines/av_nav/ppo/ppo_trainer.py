...
from savnce.tasks.shortest_path_follower import ShortestPathFollower
...
from savnce_baselines.common.rollout_storage import RolloutStorage
...
from savnce_baselines.av_nav.ppo.policy import AudioNavBaselinePolicy
from savnce_baselines.av_nav.ppo.ppo import PPO
...
@baseline_registry.register_trainer(name="avnav_ppo")
class PPOTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config, observation_space=None) -> None:
        ...
        self.actor_critic = AudioNavBaselinePolicy(
            ...
            use_pretrained=ppo_cfg.use_pretrained,
            pretrained_path=ppo_cfg.pretrained_path
        )
