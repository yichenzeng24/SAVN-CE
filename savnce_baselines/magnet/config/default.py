...
_C = CN()
_C.SEED = 0
_C.BASE_TASK_CONFIG_PATH = "configs/savnce/magnet/mp3d/savnce_clean.yaml"
_C.TASK_CONFIG = CN()  # task_config will be stored as a config node
_C.CMD_TRAILING_OPTS = []  # store command line options as list of strings
_C.TRAINER_NAME = "magnet_ddppo"
...
_C.RL.PPO.policy_type = 'savnce'
_C.RL.PPO.use_external_memory = False
_C.RL.PPO.use_mlp_state_encoder = False
_C.RL.PPO.use_goal_descriptor = False
_C.RL.PPO.use_goal_as_target = False
# -----------------------------------------------------------------------------
# SCENE MEMORY TRANSFORMER CONFIG
# -----------------------------------------------------------------------------
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER = CN()
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.memory_size = 300
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.embedding_size = 256
...
_C.RL.PPO.SCENE_MEMORY_TRANSFORMER.dropout = 0.1
...
# -----------------------------------------------------------------------------
# GOAL DESCRIPTOR NETWORK CONFIG
# -----------------------------------------------------------------------------
_C.RL.PPO.GOAL_DESCRIPTOR = CN()
_C.RL.PPO.GOAL_DESCRIPTOR.online_training = False
_C.RL.PPO.GOAL_DESCRIPTOR.lr = 1e-3
_C.RL.PPO.GOAL_DESCRIPTOR.min_episode_steps = 30
_C.RL.PPO.GOAL_DESCRIPTOR.memory_size = 128
_C.RL.PPO.GOAL_DESCRIPTOR.use_goal_descriptor_embedding = True
_C.RL.PPO.GOAL_DESCRIPTOR.encoding_goal_descriptor = True
_C.RL.PPO.GOAL_DESCRIPTOR.embedding_size = 128
_C.RL.PPO.GOAL_DESCRIPTOR.output_format = 'ACCDDOA'
_C.RL.PPO.GOAL_DESCRIPTOR.output_size = 84
_C.RL.PPO.GOAL_DESCRIPTOR.audio_goal_uuid = 'binaural_extractor'
_C.RL.PPO.GOAL_DESCRIPTOR.use_visual_encoding = False
_C.RL.PPO.GOAL_DESCRIPTOR.use_pose_encoding = True
_C.RL.PPO.GOAL_DESCRIPTOR.use_action_encoding = True
_C.RL.PPO.GOAL_DESCRIPTOR.use_pretrained = False
_C.RL.PPO.GOAL_DESCRIPTOR.pretrained_path = ''
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# GOAL DESCRIPTOR SENSOR
# -----------------------------------------------------------------------------
_TC.TASK.GOAL_DESCRIPTOR_SENSOR = CN()
_TC.TASK.GOAL_DESCRIPTOR_SENSOR.TYPE = "GoalDescriptor"
_TC.TASK.GOAL_DESCRIPTOR_SENSOR.OUTPUT_SIZE = 84
_TC.TASK.GOAL_DESCRIPTOR_SENSOR.EMBEDDING_SIZE = 256
