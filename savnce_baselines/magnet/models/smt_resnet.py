...
# Description: Adapted ResNet-18 with the number of channels reduced by half for MAGNet.

from typing import Callable, Optional, List, Type, Union, Any
import torch
...
def custom_resnet18(**kwargs: Any) -> ResNet:
...
if __name__ == "__main__":
    ...
    model = custom_resnet18(num_input_channels=3)
    print(model)
