...
from savnce.tasks.nav import PoseSensor, SpectrogramSensor, LocationBelief, CategoryBelief, Category
...
from savnce_baselines.savi.models.visual_cnn import VisualCNN
from savnce_baselines.savi.models.audio_cnn import AudioCNN
from savnce_baselines.savi.models.smt_state_encoder import SMTStateEncoder
from savnce_baselines.savi.models.smt_cnn import SMTCNN
...
class AudioNavBaselineNet(Net):
    ...
    def __init__(
        ...
        if self._audiogoal:
            ...
            summary(self.audio_encoder.cnn, audio_shape, device='cpu')

        if use_pretrained:
            assert(pretrained_path != '')
            load_pretrained_weights(self, pretrained_path, dict_key='state_dict', prefix='actor_critic.net.', logger=logger)
