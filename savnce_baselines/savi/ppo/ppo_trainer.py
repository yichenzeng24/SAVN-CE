...
from savnce.tasks.nav import LocationBelief, CategoryBelief, SpectrogramSensor
...
from savnce_baselines.savi.ppo.policy import AudioNavBaselinePolicy, AudioNavSMTPolicy
from savnce_baselines.savi.ppo.ppo import PPO
from savnce_baselines.savi.models.rollout_storage import RolloutStorage, ExternalMemory
from savnce_baselines.savi.models.belief_predictor import BeliefPredictor
...
@baseline_registry.register_trainer(name="savi_ppo")
class PPOTrainer(BaseRLTrainer):
    ...
    def train_belief_predictor(self, rollouts):
        ...
        for e in range(num_epoch):
            ...
            for sample in data_generator:
                ...
                bitwise_close = torch.sqrt(torch.sum(torch.square(preds - transformed_gts), dim=1)) < dist_thd
    ...
    def _eval_checkpoint(
        ...
        if self.config.RL.PPO.use_belief_predictor and 'test' in config.EVAL.SPLIT:
