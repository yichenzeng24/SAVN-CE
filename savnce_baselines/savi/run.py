...
from savnce_baselines.savi.config.default import get_config
from savnce_baselines.savi.ppo.policy import AudioNavSMTNet
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        # required=True,
        default='savnce_baselines/savi/config/mp3d/rgbd_ddppo_clean_train.yaml',
