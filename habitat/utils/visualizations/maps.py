...
TOP_DOWN_MAP_COLORS[MAP_SOURCE_POINT_INDICATOR] = [112, 48, 160]  # Purple
TOP_DOWN_MAP_COLORS[MAP_DISTRACTOR_POINT_INDICATOR] = [255, 0, 255]    # magenta
...
TOP_DOWN_MAP_COLORS[MAP_SILENT_PATH_COLOR] = [68, 114, 196] # Light blue (RGB)
TOP_DOWN_MAP_COLORS[MAP_SOUNDING_PATH_COLOR] = [255, 192, 0] # Light yellow (RGB)
...
def colorize_draw_agent_and_fit_to_height(
    ...
    top_down_map = draw_agent(
        ...
        agent_radius_px=min(top_down_map.shape[0:2]) // 16,
    )
